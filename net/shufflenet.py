...
class InvertedResidual(nn.Module):
    ...
    @staticmethod
    def depthwise_conv(input_c,output_c,kernel_size,stride,padding,bias:bool=False):
        return nn.Conv2d(input_c,output_c,kernel_size,stride,padding,bias=False,groups=input_c)
...
if __name__=='__main__':
    inputs=torch.rand(4,64,28,28)
    out=channel_shuffle(inputs,4)
    print(out.shape)
